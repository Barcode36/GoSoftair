...
?>  
            	<tr><td><?php echo ((is_array($_tmp=$this->_tpl_vars['datiPartite'][$this->_sections['i']['index']]['partitaID'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 10, " [...]") : smarty_modifier_truncate($_tmp, 10, " [...]")); ?>
</td>
...
"><?php echo $this->_tpl_vars['datiPartite'][$this->_sections['i']['index']]['titoloPartita']; ?>
                	...
                	<td><?php echo ((is_array($_tmp=$this->_tpl_vars['datiPartite'][$this->_sections['i']['index']]['utenteusername'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 10, " [...]") : smarty_modifier_truncate($_tmp, 10, " [...]")); ?>
</td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['datiPartiteCreate'][$this->_sections['k']['index']]['titolo'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : smarty_modifier_truncate($_tmp, 20, "...")); ?>
</a></td>
