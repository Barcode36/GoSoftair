<?php /* Smarty version 2.6.26, created on 2015-09-17 17:09:47
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['datiPartite'][$this->_sections['i']['index']]['titolo'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : smarty_modifier_truncate($_tmp, 20, "...")); ?>
                ...
                <td><?php echo ((is_array($_tmp=$this->_tpl_vars['datiPartite'][$this->_sections['i']['index']]['autore'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : smarty_modifier_truncate($_tmp, 20, "...")); ?>
</td>
