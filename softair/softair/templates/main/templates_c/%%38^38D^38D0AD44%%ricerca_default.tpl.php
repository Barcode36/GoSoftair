<?php /* Smarty version 2.6.26, created on 2015-07-03 16:34:59
...
<?php else: ?>-<?php endif; ?></a> | Categoria: <a href="#"><?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['categoria']; ?>
              ...
              <input type="hidden" name="id_libro" value="<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['IDpartita']; ?>
" />
